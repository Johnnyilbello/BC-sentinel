...
if (-not (Test-Path $ServiceExe)) { throw "Upgrade live richiede una precedente installazione BC Sentinel. Il reboot resta escluso, ma upgrade/repair non viene saltato." }
...
} else { throw "Upgrade acceptance fallita" }
