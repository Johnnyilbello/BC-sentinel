...
Write-Host "BC Sentinel v0.10.0-rc.1 FIX2 - RETEST standard-user -> UAC from ADMIN" -ForegroundColor Cyan
$uacOut = Join-Path $env:TEMP ("bc-sentinel-rc1-standard-uac-retest-" + [guid]::NewGuid().ToString("N") + ".json")
