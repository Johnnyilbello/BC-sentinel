...
!endif
!ifndef UNINSTALL_SIGN_WRAPPER
  !error "UNINSTALL_SIGN_WRAPPER is required"
!endif
...
Name "${PRODUCT_NAME}"
OutFile "${OUTPUT_DIR}\BC-Sentinel-Setup-v0.13.0-b134.exe"
...
VIAddVersionKey /LANG=1033 "FileVersion" "0.13.0.0"
...
!uninstfinalize 'powershell.exe -NoProfile -ExecutionPolicy Bypass -File "${UNINSTALL_SIGN_WRAPPER}" "%1"'
...
Section "Uninstall"
  ...
  ; Persistent product/security data remains outside $INSTDIR by default.
SectionEnd
