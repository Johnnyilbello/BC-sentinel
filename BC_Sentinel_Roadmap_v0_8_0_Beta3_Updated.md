...
Current development line: **v0.8.0-beta.3 — Signed Remote Threat Index, Controlled Retrieval & Revocation Operations**.
...
### v0.8.0-beta.3 — Signed Remote Threat Index, Controlled Retrieval & Revocation Operations (current)
...
### Remaining v0.8 work
- external/offline signing operations and production key custody/runbook;
- production remote endpoint configuration and certificate-pin rotation policy;
- release transparency/provenance export;
- publisher-signature-required distributed application/service updater once signing infrastructure exists;
- optional delta/update efficiency after full-package safety is frozen;
- final v0.8 release-candidate consolidation before starting v0.9.
